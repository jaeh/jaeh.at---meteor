...
Meteor.startup(function() {
  ...
  var page404Id = Pages.insert(page_404);
  /*
  var page_403 = {
    title: 'This has gone terribly, horribly wrong.',
    slug: '403',
    body: '<div class="float-left"><img src="/403.png" title="GROOOOWL!!!" alt="GROOOOWL!" /></div>'+
    '<div class="float-right">'+
      '<p>something has gone wrong here. terribly, horribly wrong.</p>'+
      '<p>even rainbow dash is mad about you. as you can obviously see. we suspect you are hackking around there? stop it please.</p>'+
      '<p>if you actually find gross security issues with this page please <a href="/contact">contact</a> me :)</p>'+
    '</div>',
    footer: 'haxxors gonna hack',
    published: true
  };
  
  var page403Id = Pages.insert(page_403);
    */
